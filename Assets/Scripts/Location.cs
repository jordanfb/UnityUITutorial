...
public class Location : ScriptableObject
{
    ...
    [Tooltip("Money Sloth Strength Fun Fruit Disease Sleep, x = min, y = max, inclusive")]
    ...
    public Sprite locationPicture; // the picture of the location. I may not use this
